...
class Okno_interfejsu_glownego(wx.Frame):
    ...
    def intiUI(self):
        ...
        self.Bind(wx.EVT_MENU,self.test, pomoc_0) 
        ...
        self.Przycisk_symulacja.Bind(wx.EVT_BUTTON,self.wx_symulacja)
        ...
        self.Przycisk_animacja.Bind(wx.EVT_BUTTON, self.wx_test_animacje) #Nie ma funkcji
    ...
    def wx_test_animacje(self,evt):
        dialog=wx.FileDialog(self,message='Wybierz plik z zapisaem symulacji',defaultFile='',wildcard='*.TXT',style=wx.FD_OPEN, pos=(10,10))
        ...
        ok3=Okno_animacji()
        ok3.Show()
    def wx_animacja(self,nazwa_pliku): ##ZMIANA - stara wersja funkcji na moim kompie 
        #zawieszała kompletnie pythona powyzej 10 generacji, a u Patki na
        #laptopie działała ponad 2x dłużej i używała gigabajty pamięci przy 100gen 
        # podejscie z poolami zamiast queue ogranicza generowane procesy pythona, 
        #przez co uzycie pamieci jest znikome a procesor nie jest bombardowany 
        #setką procesów na raz, tylko iloscia adekwatna do liczby watkow procesora
        """
        ...
        jest rozdzielana za pomocą multiprocesingu na procesy potomne w 
        ...
        symulacji. Mapy te są zostają po zwórceniu ze wspomnianej funckji
...
def koloruj_mapę(ścieżka,macierz,nazwa,krok,szerokość):##ZMIANA##< wyrzucilem tutaj kolejke z argumentow bo korzystam z poola 
    """
    ...
    nazwa (str) : nazwa pliku "*.txt", w któym znajduje się zapis Środowiska,
